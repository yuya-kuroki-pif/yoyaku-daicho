...
const I18N = {
  ja: {
    ...
    openSite: '開く',
    copied: 'コピーしました ✓',
    ownNote: 'このURLを開くとお客様がネット予約できます（同じWi-Fi内の端末からアクセス可能）。受付の停止は下の「自社サイト」の受付ボタン、予約可能な席は連携テーブルで設定します。ネット予約は台帳へ自動反映されます。',
    secWhen: '日時・人数',
    secTable: 'テーブル',
    secGuest: 'お客様情報',
    secOther: 'その他',
  ...
  vi: {
    ...
    openSite: 'Mở',
    copied: 'Đã sao chép ✓',
    ownNote: 'Mở URL này để khách tự đặt bàn trực tuyến (truy cập được từ thiết bị cùng Wi-Fi). Dừng nhận đặt bằng nút trạng thái của「Trang của cửa hàng」bên dưới, chọn bàn cho phép đặt bằng「Bàn liên kết」. Đặt bàn trực tuyến tự động ghi vào sổ.',
